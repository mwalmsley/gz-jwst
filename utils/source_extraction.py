...
def extract_objects_from_mosaic(filename):
...
def chop_larger_mosaic(mosaic_data, chop_loc, along_which_axis='both'):
    if along_which_axis == 'both':
        return mosaic_data[:chop_loc,:], mosaic_data[:,:chop_loc]
    elif along_which_axis == 'x':
        return mosaic_data[:chop_loc,:], None
    elif along_which_axis == 'y':
        None, mosaic_data[:,:chop_loc]
    else:
        assert along_which_axis in ['both','x', 'y']
