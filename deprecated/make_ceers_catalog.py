...
list_of_relevant_files = glob.glob('data/dev_data/hlsp_ceers*{}*'.format(filter_band_kwarg))
...
processed_table_given_bkg, cleaned_segmap_given_bkg = catalog_for_survey.extract_objects_from_mosaic(
    list_of_relevant_files[0], use_existing_bkg=True, fits_ext=2, chop_mosaic=False, sep_config=sep_config
)